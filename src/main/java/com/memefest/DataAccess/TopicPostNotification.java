...
@NamedQueries({
    ...
    @NamedQuery(name = "TopicPostNotification.getTopicNotificationByPostId",
        query = "SELECT tPN FROM TopicPostNotificationEntity tPN WHERE tPN.postId = :postId"),
    @NamedQuery(name = "TopicPostNotification.getTopicNotificationByUser",
        query =  "SELECT tPN FROM TopicPostNotificationEntity tPN WHERE tPN.userId = :userId" )
})
