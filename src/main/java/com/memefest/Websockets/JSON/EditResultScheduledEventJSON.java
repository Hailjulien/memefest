...
@JsonRootName("EditResultScheduledEvent")
public class EditResultScheduledEventJSON extends EditResultJSON {
    ...
    @JsonCreator
    public EditResultScheduledEventJSON(@JsonProperty("ResultCode") int resultCode, 
