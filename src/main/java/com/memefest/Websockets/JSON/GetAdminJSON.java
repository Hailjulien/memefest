...
@JsonRootName("GetAdmin")
public class GetAdminJSON extends GetUserJSON {

    @JsonProperty("Admins")
    private  Set<AdminJSON> admins;

    @JsonCreator
    public GetAdminJSON(@JsonProperty("Admins") Set<AdminJSON> admins){
        super(admins.stream().map(candidate ->{
