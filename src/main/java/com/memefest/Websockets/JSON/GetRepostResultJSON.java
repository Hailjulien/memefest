...
public class GetRepostResultJSON extends ResultJSON{
    
    @JsonProperty("Reposts")
    private Set<RepostJSON> reposts;

    @JsonCreator
    public GetRepostResultJSON(@JsonProperty("ResultCode") int resultCode, @JsonProperty("ResultMessage")String resultMessage,
