...
public class GetAdminMessageHandler implements MessageHandler.Whole<GetAdminJSON>{

   private UserOperations userOps;
   private Session session;

   public GetAdminMessageHandler(UserOperations userOps, Session session){
   ...
   //add customisation filter according to users tastes here
    @Override
    public  void onMessage(GetAdminJSON userEdit){
